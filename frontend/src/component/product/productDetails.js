                ...
                <Fragment>
                    <Metadata title={`Your no 1 online shopping mart`} />
                        ...
                        <div className="row d-flex justify-content-around">
                            ...
                            <div className="col-6 col-sm-12 col-md-4 mt-5">
                                ...
                                <div className="d-inline-flex p-2 bd-highlight">
                                    <span type="button "className="btn btn-danger minus" onClick={decrementQuantityStock}>-</span>

                                    <input id="form-control" className="form-control count d-inline" type="number" value={quantity} readonly />
                                        
                                    <span type="button" className="btn btn-primary plus" onClick={incrementQuantityStock}>+</span>
                                <button type="button" id="cart-button" className="btn btn-primary d-inline ml-2" >Add to Cart</button>  
                                </div>

                                <hr />
                                
                                <p>Status: <span id="status_stock" className={product.stock > 0 ? "green-color" : "red-color"}>
